 ...
 *
 * <p>The profile specifies how much electricity, water, and gas
 * a device consumes when it is in the ON state.</p>
 *
 * <p>This model is intentionally simplified:
 * <ul>
 ...
 * </p>
 *
 * <p>The actual consumption is calculated by {@code Device.accumulateConsumption()}
 * based on the simulation step duration.</p>
 */
